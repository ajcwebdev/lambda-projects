...
Middleware takes a response and transforms it or performs some sort of operation on the request before sending back a response.

-   [ ] Describe a Resource?

In a RESTful api everything is a resource and each resource can be accessed by a unique URI.
...
We can break apart our routers into different files based on categories like posts or users.
