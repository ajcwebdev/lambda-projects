...
A token is a unique and secure identifier to authenticate and authorize a user to log into a site or app and perform protected functionality.

- [ ] What steps can you take in your web apps to keep your data secure?

Make sure that routes are protected and require authentication. Create axiosWithAuth util that sets token to localStorage for logging users in.

- [ ] Describe how web servers work.

Web server can refer to either a computer that stores the code for a website or a program that runs on such a computer. The physical computer device is connected to the internet and stores the code for different websites. When we load the code for our websites the server is “hosting” our website/app. The software program "serves" web pages from the project's code to users upon request.
