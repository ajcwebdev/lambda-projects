...
useRouteMatch matches the URL exactly like a `<Route>`, including exact, strict, and sensitive options. It can get access to a `<Route>`'s match data and is useful for rendering a `<Route>` by itself outside a `<Switch>`.

2. How would you explain form validation to someone who has never programmed before?

Form validation makes sure that when you are filling out an online form to give a website your information such as name, email, and phone number, you are entering information that makes sense for the field. So you would get an error if you tried to answer john@name.com for phone number and 555-555-5555 for email.

3. In 1-2 sentences, define end to end testing.

End to end testing holistically tests the whole process a user would go through to use your website, starting with opening the page, clicking on buttons, and entering information into the forms.
